<template>
    <view v-if="visible" class="base-popup" @touchmove.stop.prevent>
        <view class="overlay" :style="[overlayStyle, overlayAnimation]" :class="overlayClass" @tap="overlayClick" />
        <view
            class="popup-body"
            :style="[bodyStyle]"
            :class="[safeAreaInsetBottom ? 'safe-area-inset-bottom' : '', bodyClass]"
        >
            <slot />
        </view>
    </view>
