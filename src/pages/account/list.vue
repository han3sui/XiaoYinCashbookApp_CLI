<template>
    <view class="body">
        ...
        <view class="bottom">
            ...
            <view class="tips">
                <text v-if="checkStatus === -1" style="color: #e6a23c">快来进行第一次核账吧~</text>
                <text v-if="checkStatus === 1" style="color: #67c23a">恭喜，您拥有一份完美的账单~</text>
                <view v-if="checkStatus === 0" style="color: #e6a23c">
