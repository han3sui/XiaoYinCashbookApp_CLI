  ...
  <view class="body">
    <view class="form-wrap">
      <view class="form-item">
        ...
        <input class="input" v-model="data.name" placeholder="请输入账户名称" placeholder-style="font-size:28rpx"/>
      </view>
      <view class="form-item">
        <view class="title">账户余额</view>
        <input class="input" v-model="data.balance" type="digit" placeholder="请输入账户余额"
